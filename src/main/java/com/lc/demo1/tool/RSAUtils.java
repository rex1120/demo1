...
import com.lc.demo1.configuration.ConstantsPile;
...
public class RSAUtils {
    ...
    public static KeyPair getKeyPair() throws Exception {
        KeyPairGenerator generator = KeyPairGenerator.getInstance(ConstantsPile.RSA_ALGORITHM);
    ...
    public static PrivateKey getPrivateKey(String privateKey) throws Exception {
        KeyFactory keyFactory = KeyFactory.getInstance(ConstantsPile.RSA_ALGORITHM);
    ...
    public static String sign(String data, PrivateKey privateKey) throws Exception {
        ...
        Signature signature = Signature.getInstance(ConstantsPile.RSA_MD5_ALGORITHM);
